 ...
 * @returns {WebGLBuffer}
 */
export declare function createBuffer(gl: WebGLRenderingContext, data: Float32Array | Float64Array, usage?: number): WebGLBuffer;
/**
 ...
 * @returns {WebGLBuffer}
 */
export declare function createIndexBuffer(gl: WebGLRenderingContext, indices: Uint16Array | Uint32Array, usage?: number): {
    buffer: WebGLBuffer;
    count: number;
};
/**
