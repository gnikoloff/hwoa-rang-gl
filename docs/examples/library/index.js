var hwoaRangGL = (function (exports) {
    'use strict';
...
`;
    ...
    class InstancedMesh extends Mesh {
        ...
        setMatrixAt(index, matrix) {
            const itemsPerInstance = 16;
            const { buffer, typedArray } = this.instanceAttributes.get(INSTANCED_OFFSET_MODEL_MATRIX);
            ...
            __classPrivateFieldGet(this, _gl$3).bufferData(__classPrivateFieldGet(this, _gl$3).ARRAY_BUFFER, typedArray, __classPrivateFieldGet(this, _gl$3).DYNAMIC_DRAW);
            this.vaoExtension.bindVertexArrayOES(null);
        }
        draw() {
            if (this.modelMatrixNeedsUpdate) {
    ...
    class Texture {
        constructor(gl, { image = null, width, height, format = gl.RGB, internalFormat = format, type = gl.UNSIGNED_BYTE, isFlip = true, useMipmaps = false, wrapS = gl.CLAMP_TO_EDGE, wrapT = gl.CLAMP_TO_EDGE, anisotropy = 0, }) {
            ...
            if (anisotropy) {
                gl.texParameterf(gl.TEXTURE_2D, getExtension(gl, 'EXT_texture_filter_anisotropic')
        ...
        bind() {
            __classPrivateFieldGet(this, _gl$4).bindTexture(__classPrivateFieldGet(this, _gl$4).TEXTURE_2D, this.texture);
            return this;
        }
        unbind() {
    ...
    var _gl$5, _buffer, _depthBuffer, _textures;
    class RenderTarget {
        constructor(gl, { width = gl.canvas.width, height = gl.canvas.height, target = gl.FRAMEBUFFER, wrapS = gl.CLAMP_TO_EDGE, wrapT = gl.CLAMP_TO_EDGE, format = gl.RGBA, internalFormat = format, depth = true, }) {
            ...
            __classPrivateFieldGet(this, _textures).push(tex);
        ...
        bindTexture() {
            __classPrivateFieldGet(this, _textures)[0].bind();
            return this;
        }
        unbindTexture() {
            __classPrivateFieldGet(this, _textures)[0].unbind();
            return this;
        }
    }
    _gl$5 = new WeakMap(), _buffer = new WeakMap(), _depthBuffer = new WeakMap(), _textures = new WeakMap();
    ...
    class PerspectiveCamera {
      ...
      constructor(fieldOfView, aspect, near, far) {
        ...
        perspective(this._projectionMatrix, fieldOfView, aspect, near, far);
      }
      ...
      updateViewMatrix() {
        lookAt(this._viewMatrix, this.position, this.lookAtPosition, PerspectiveCamera.UP_VECTOR);
      }

      lookAt(target) {
        console.log(target);
        this.lookAtPosition = target;
        lookAt(this._viewMatrix, this.position, target, PerspectiveCamera.UP_VECTOR);
      }
    }
