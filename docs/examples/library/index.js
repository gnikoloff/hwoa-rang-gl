var hwoaRangGL = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    const UNIFORM_TYPE_MATRIX4X4 = 'matrix4fv';
...
`;
    ...
    class Texture {
        constructor(gl, { image = null, width, height, format = gl.RGB, internalFormat = format, type = gl.UNSIGNED_BYTE, isFlip = true, useMipmaps = false, wrapS = gl.CLAMP_TO_EDGE, wrapT = gl.CLAMP_TO_EDGE, anisotropy = 0, minFilter = gl.LINEAR, magFilter = gl.LINEAR }) {
            ...
            if (image) {
                if (image instanceof HTMLVideoElement || image instanceof HTMLImageElement || image instanceof HTMLCanvasElement) {
                    ...
                    internalFormat, width, height, 0, // border
                    format, type, image);
                }
