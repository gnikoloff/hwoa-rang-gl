...
`;
	...
	set$1(lightWorldPosition, 0, 0, MOVEMENT_LIGHT_RADIUS);
	...
	set$1(position, ...lightPointerHelperMeshOuter.position);
	lookAt$1(spotLightMat, position, target, up);
