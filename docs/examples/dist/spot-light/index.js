...
`;
	...
	set(lightWorldPosition, 0, 0, MOVEMENT_LIGHT_RADIUS);
	...
	set(position, ...lightPointerHelperMeshOuter.position);
	lookAt(spotLightMat, position, target, up);
