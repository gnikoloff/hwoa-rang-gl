...
`;
	...
	const projectionScaleVec = create$1();
	const cubeScaleVec = create$1();
	...
	const updateTexMatrix = ({
	  ...
	  set(projectionScaleVec, projectionScale, 0, projectionScale);

	  identity(textureWorldMatrix);
	  lookAt(textureWorldMatrix, projectionPos, projectionTarget, UP_VECTOR);
	  scale(textureWorldMatrix, textureWorldMatrix, projectionScaleVec);
