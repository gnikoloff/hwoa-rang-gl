...
`;
	...
	const textureWorldMatrix = create$3();
	const projectionPos = create$2();
	const projectionTarget = create$2();
	const projectionScaleVec = create$2();
	const cubeScaleVec = create$2();
	...
	const updateTexMatrix = ({
	  ...
	  set$1(projectionPos, posX, posY, posZ);
	  set$1(projectionTarget, targetX, targetY, targetZ);
	  set$1(projectionScaleVec, projectionScale, 0, projectionScale);

	  identity$1(textureWorldMatrix);
	  lookAt$1(textureWorldMatrix, projectionPos, projectionTarget, UP_VECTOR);
	  scale$1(textureWorldMatrix, textureWorldMatrix, projectionScaleVec);
