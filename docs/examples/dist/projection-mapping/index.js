...
`;
	...
	class PerspectiveCamera {
	    ...
	    updateViewMatrix() {
	        lookAt$1(this.viewMatrix, this.position, this.lookAtPosition, PerspectiveCamera.UP_VECTOR);
	        return this;
	    }
	    updateProjectionMatrix() {
	        perspective$1(this.projectionMatrix, this.fieldOfView, this.aspect, this.near, this.far);
	        return this;
	    }
	    lookAt(target) {
...
`;
	...
	const textureWorldMatrix = create();
	const textureProjectionMatrix = create();
	...
	const updateTexMatrix = ({
	  ...
	  invert(textureWorldMatrixInv, textureWorldMatrix);
	  ...
	  scale(textureMatrix, textureMatrix, transformVec);
	  mul(textureMatrix, textureMatrix, textureProjectionMatrix);
	  ...
	  invert(textureProjectionMatrixInv, textureProjectionMatrix);

	  mul(cubeWorldMatrix, textureWorldMatrix, textureProjectionMatrixInv);
