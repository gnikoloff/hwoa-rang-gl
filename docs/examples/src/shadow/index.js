...
const updateTexMatrix = ({
  ...
  mat4.lookAt(lightWorldMatrix, projectionPos, projectionTarget, UP_VECTOR)
  ...
  mat4.invert(textureProjectionMatrixInv, lightProjectionMatrix)

  mat4.mul(cubeWorldMatrix, lightWorldMatrix, textureProjectionMatrixInv)
